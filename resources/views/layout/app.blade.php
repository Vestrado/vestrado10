			...
			<div class="flex flex-1">
				...
				<main class="flex-1 p-4 md:p-6 lg:p-8 space-y-8">
                  ...
                  0 00.95-.69l1.286-3.966z" />
								...
								<p class="text-sm text-gray-600 mb-2">50 LOTS / 370 PTS</p>
							</a>
						</div>
